...
function populateDropDowns() {
	...
	var ddYears = document.getElementById(__publs_dd_years_id);
	var ddTags = document.getElementById(__publs_dd_tags_id);
	var ddJournals = document.getElementById(__publs_dd_journals_insts_id);
	var ddWorkTypes = document.getElementById(__publs_dd_wt_id);
